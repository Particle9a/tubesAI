...
def displayPapan(takenPos, whiteList, blackList) :
	for i in range(0,8):
		...
		print(string)
	if (blackList == []):
		print(countThreat1(whiteList,takenPos))
		print()
		print("Positions =")
		print(takenPos)
		print()
		print("Threats (same color)")
		printThreat1(whiteList,takenPos)
	else :
		print(countThreat1(whiteList,takenPos)+countThreat1(blackList,takenPos), countThreat2(whiteList,blackList,takenPos))
		print()
		print("Positions =")
		print(takenPos)
		print()
		if (countThreat1(whiteList, takenPos) > 0) :
			print("Threats (White)")
			printThreat1(whiteList,takenPos)
			print()
		if (countThreat1(blackList, takenPos) > 0) :
			print("Threats (Black)")
			printThreat1(blackList,takenPos)
			print()
